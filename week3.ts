...
// The simulation should include classes for Soldier and Army, with methods for attacking and checking the status of the armies.

// Step 1: 
// Create two classes: Soldier and Army. Soldiers can be formed to an army. Soldier has hp, attack strength and hit percentage. 
...
export class Soldier {
  ...
  // Step 2: 
  // One soldier can attack another soldier, the parameter target is the solder to be attacked. 
  // The attack only happens if the hit chance is less or equal to this soldier's hit percentage (hitChance <= this.hitPercentage)
